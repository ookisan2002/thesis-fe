...
export function CustomeCarCard({
  ...
  return (
    <div
      key={key}
      {...props}
      className={`${key} p-[1.88rem] tablet:p-[2.88rem] h-fit bg-white shadow-[6px_0px_39.768px_0px_rgba(0,0,0,0.05)] rounded-[0.9375rem] tablet:rounded-[1.9375rem] ${className}`}
    >
